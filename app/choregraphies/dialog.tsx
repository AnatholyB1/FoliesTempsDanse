...
const choregraphieSchema = z.object({
  ...
  tableauId: z.string().min(1, "Le tableau est requis"),
...
export function ChoregraphieFormDialog({
  ...
  const form = useForm<ChoregraphieFormValues>({
    ...
    defaultValues: {
      ...
      tableauId: editChoregraphie?.tableauId ?? (tableaux[0]?._id ?? ""),
          ...
          <DialogContent className="animate-fade-in">
            <DialogHeader>
              <DialogTitle className="text-xl font-semibold mb-2">
                {editChoregraphie ? "Modifier la chorégraphie" : "Créer une chorégraphie"}
              </DialogTitle>
            </DialogHeader>
            <FormField
              name="nom"
            ...
            <FormField
              ...
              render={({field}) => (
                <FormItem>
                  <FormLabel htmlFor="tableauId">Tableau</FormLabel>
                  <FormControl>
                    <Select
                      value={field.value}
                      ...
                      disabled={loading}
                    >
                      <SelectTrigger id="tableauId" className="w-full bg-card text-card-foreground">
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="animate-fade-in">
        <DialogHeader>
          ...
          <DialogDescription>
            Voulez-vous vraiment supprimer la chorégraphie{" "}
