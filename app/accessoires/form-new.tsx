...
import type {CreateAccessoire} from "@/type";
...
export default function AccessoireNewForm({onCreated, onClose}: Props) {
    const {mutate: createAccessoire, isPending} = useMutation({
    ...
    const onSubmit = (data: AccessoireFormValues) => {
        createAccessoire(data as CreateAccessoire);
    };
    ...
    return (
        <Form {...form}>
            ...
            >
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input {...field} placeholder="Type d'accessoire" />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input {...field} placeholder="Autres infos" />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}
                ...
                />
                <Button type="submit" className={"absolute bottom-6"} disabled={isPending}>
